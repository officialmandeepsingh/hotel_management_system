...
class adm_signup:
    ...
    def getdatabase(self):
        ...
        try:
            ...
            with mydb.cursor() as myconn:
                ...
                myconn.execute("insert into users(ename,dob,address,gender,phone,email,userid,password,doj,usertype)values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(name,mydob,address,mygender,phone,email,username,password,mydoj,myusertype))
                mydb.commit()
    ...
    def __init__(self,frame):
        myframe = Toplevel(frame)
        myframe.wm_title("Employee Registered Form")
        ...
        try:
            ...
            self.e9 = Entry(myframe,width=27)#doj
            ...
            self.usertype=Combobox(myframe,state="readonly",textvariable=self.usertypeent)
            self.usertype.config(values=('Admin','Employee'))
            self.usertype.set("Choose User type")
